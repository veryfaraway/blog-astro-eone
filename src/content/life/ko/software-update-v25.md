...
참고로 현재 2.3 버전과 [2.4 버전](/life/1024-software-update-v24 "2.4 버전")은 OTA로 제공되지 않습니다. 업데이트를 원하시면 서비스 센터에 방문해서 설치할 수 있습니다. 2.5 버전은 2.4 버전의 내용을 포함하고 있으며 2.5 버전이 정상적으로 OTA로 서비스된다면 2.2 버전에서 2.5로 업데이트하면 됩니다.
