...
<Alert type="info" title="ScummVM이 지원하는 게임 목록이 궁금하다면?">
...
<Alert type="warning" title="Special Edition vs. 오리지널">
...
<Alert type="success" title="Intel Mac 사용자">
...
<Alert type="success" title="세이브는 자주 하자">
